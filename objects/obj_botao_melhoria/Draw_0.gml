...
if(escreve_funcao) draw_text_ext_transformed(120, 126, funcao, 60, 1500, 0.1, 0.1, image_angle);
...
if(escreve_funcao) draw_text_ext_transformed(120, 125, funcao, 60, 1500, 0.1, 0.1, image_angle);
