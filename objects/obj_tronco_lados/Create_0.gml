...
//array de colisao
colisoes = [obj_arvore, obj_tronco_vertical, obj_mago_tapete, obj_caixa,obj_totem, obj_lava];

//array de colsisoes que afetam
colisoes_afetam = [obj_poder_essecia, obj_pedra, obj_tronco_lados, obj_caixa];
...
maquina_estados = function()
{
    ...
    switch (estado) 
    {
        ...
        case "caindo_direita":
            ...
            if (instance_place(x + 15, y, colisoes)) 
            {
                //Ele se destroi
                alarm[0] = 2;
            }
