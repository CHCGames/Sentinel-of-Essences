...
if(outline and global.poder == false) draw_sprite_ext(spr_icones_loja_outline, image_index, x, y, xscale, yscale, image_angle, 
    image_blend, image_alpha);

//Caso ele chegue no nível max
if(global.poder == true) draw_sprite_ext(spr_icones_loja_mascara, image_index, x, y, xscale, yscale, image_angle,
    image_blend, 0.5);
